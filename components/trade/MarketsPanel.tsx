...
export function MarketsPanel(props: {
  ...
  const { tickers, activeSymbol, onPick, error } = props;
  ...
  return (
    ...
    >
      ...
      {/* Column headers */}
      <div
        className="px-4 pb-2 grid text-[10px] uppercase tracking-wider font-bold"
        style={{ color: "#3f3f46", gridTemplateColumns: "1fr 90px 70px 56px" }}
      >
        <span>Token</span>
